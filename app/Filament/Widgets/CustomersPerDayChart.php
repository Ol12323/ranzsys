...
class CustomersPerDayChart extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static ?string $chartId = 'customersPerDayChart';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'Customers Per Day Chart';
     ...
     protected function getFormSchema(): array
    {
        return [
            ...
            ->options([
                ...
                'Online Order' => 'Online Order Customers',
            ]),
