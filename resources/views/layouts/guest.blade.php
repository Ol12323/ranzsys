            ...
            <div class="container px-6 py-12 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div>
                        ...
                        <p class="mt-2 text-blue-500">ranzphotography@yahoo.com</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-blue-500">Door 1 Grageda Bldg. Quezon St. New Pandan</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-blue-500">0946 052 0523</p>
                    </div>
                </div>
            </div>
        </section>
