  ...
  <div class="w-full bg-center bg-cover h-[38rem]" style="background-image: url('{{asset('images/landing-bg-image.png')}}');">
    <div class="flex items-center justify-center w-full h-full bg-gray-900/40">
        <div class="text-center">
            <h1 class="text-3xl font-semibold text-white lg:text-4xl">Capture moments, frame <span class="text-blue-500">memories</span> beautifully.</h1>
            <div class="mt-6">
                ...
                <div class="flex flex-wrap md:-m-2 -m-1">
                  <div class="flex flex-wrap w-1/2">
                    <div class="md:p-2 p-1 w-1/2">
                      <img alt="gallery" class="rounded w-full object-cover h-full object-center block opacity-85 dark:opacity-75" src="{{asset('images/image-2.jpg')}}">
                    </div>
                    <div class="md:p-2 p-1 w-1/2">
                      <img alt="gallery" class="rounded w-full object-cover h-full object-center block opacity-85 dark:opacity-75" src="{{asset('images/image-6.jpg')}}">
                    </div>
                    <div class="md:p-2 p-1 w-full">
                      <img alt="gallery" class="rounded w-full h-full object-cover object-center block opacity-85 dark:opacity-75" src="{{asset('images/image-4.jpg')}}">
                    </div>
                  </div>
                  <div class="flex flex-wrap w-1/2">
                    <div class="md:p-2 p-1 w-full">
                      <img alt="gallery" class="rounded w-full h-full object-cover object-center block opacity-85 dark:opacity-75" src="{{asset('images/image-5.jpg')}}">
                    </div>
                    <div class="md:p-2 p-1 w-1/2">
                      <img alt="gallery" class="rounded w-full object-cover h-full object-center block opacity-85 dark:opacity-75" src="{{asset('images/image-5.jpg')}}">
                    </div>
                    <div class="md:p-2 p-1 w-1/2">
                      <img alt="gallery" class="rounded w-full object-cover h-full object-center block opacity-85 dark:opacity-75" src="{{asset('images/image-8.jpg')}}">
                    </div>
                  </div>
                </div>
              </div>
