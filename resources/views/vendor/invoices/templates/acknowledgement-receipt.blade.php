...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{ asset('images/system-logo.png') }}" type="image/png">
    ...
    <body>
        ...
        <p class="seller-address">
            Address: <strong>{{ $invoice->seller->address }}</strong>
        </p>
        <p class="mt-5">We hereby acknowledge the receipt and satisfactory completion of the following services:</p>
        {{-- Table --}}
        ...
        <p class="mt-5">
            We confirm the completion of the above-mentioned services and express our appreciation for your professionalism and timely execution. Your quality of work has been commendable.
        </p>
        @if($invoice->notes)
            <p>
