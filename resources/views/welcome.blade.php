    ...
    <div class="items-center lg:flex">
        <div class="w-full lg:w-1/2">
            <div class="lg:max-w-lg">
                <h1 class="text-3xl font-semibold text-white lg:text-4xl">Premier destination for  <br> exceptional <span class="text-blue-500 ">printing and photography services </span></h1>
                
                <p class="mt-3 text-gray-400">We offer streamlined printing package orders with convenient in-store pickup. Additionally, we facilitate hassle-free online appointments for photography services.</p>
